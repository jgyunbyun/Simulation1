...
#}
if (di<7.0 & (tree.h2/tree.d2)>(tree.h/tree.d) & abs(tree.h-tree.h2)<5 & abs(tree.h-tree.h2)>0 & tree.d2>30) {
  tree.Nr4<-rbind(tree.Nr4,tree.Nr2)
}
if (di<5.0 & tree.h2<tree.h &tree.d2<30 &tree.d2<30){
...
tree.nu2<-setdiff(tree.nu2,tree.Nr6)
